                        ...
                        <form action="{{ url("/estudiante") }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group">
                                    <br><br><br><h3 id="p1">Registrarse</h1><br>
                                </div>
                                </center>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input type="text" class="form-control" name="Tipo" id="Tipo" value="Estudiante" readonly>
                                        @error('Tipo')
                                            <span style="color: red">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group" id="bt1">
                                    <center>
                                    <input type="submit"  class="btn btn-block btn-lg" name="Login" id="Login" value="Registrar">
                                ...
                                <center>
                                    <span>Tengo una Cuenta? <a href="{{ "../login" }}">Haz click aqui para loguearte </a></span>
                                </center>
                                <br>
                            </div>
                        </form>
